    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>
                    Below are some of the resources that we used throught this app.
                ...
                <ul>
                    ...
                    <li>Font Awesome for React: https://gorgangajic.github.io/react-icons/fa.html</li>
                    ...
                    <li>https://github.com/ngokevin/afram-react-boilerplates</li>
                </ul>
                <h1>More Reading</h1>
